          ...
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Bạn có vướng mắc cần giải đáp ?</h3>
                <p className="text-gray-300 text-lg mb-6">Hãy để lại email liên lạc với chúng tôi.</p>
                ...
                <form className="w-full lg:w-auto">
                  <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    ...
                    <a className="btn text-white bg-blue-600 hover:bg-blue-700 shadow whitespace-nowrap rounded-xl p-4" href="#0">
                      Đăng ký
                    </a>
                  </div>
                  {/* Success message */}
                  {/* <p className="text-sm text-gray-400 mt-3">Thanks for subscribing!</p> */}
                  <p className="text-sm text-gray-400 mt-3">hãy trờ đợi chúng tôi sẽ phản hồi sớm nhất.</p>
                </form>
              </div>
            </div>
          </div>
