      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Lĩnh vực nổi bật</h2>
            <p className="text-xl text-gray-600">NiceWork không ngừng pháp triển để phục vụ yêu cầu của khách hàng.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Công nghệ phần mền</h4>
              <p className="text-gray-600 text-center">Pháp triển phần mền và website.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Thiết kế</h4>
              <p className="text-gray-600 text-center">Thiết kế Logo, Biển hiệu, poster, ...</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Dữ liệu</h4>
              <p className="text-gray-600 text-center">Xây dựng và quản lý Database.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Editor</h4>
              <p className="text-gray-600 text-center">Xây dựng, quay và edit video.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Dịch giả</h4>
              <p className="text-gray-600 text-center">Viết và dịch thuật ngôn ngữ.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Quản trị viên</h4>
              <p className="text-gray-600 text-center">Xây dựng và quản lý kênh mạng xã hội.</p>
            </div>
